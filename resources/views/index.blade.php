  ...
  <div class="card">
    ...
    <table>
      ...
      <tr>
        ...
        @csrf
        <td>
          <input type="text" class="input-update" value="{{$item["breakfast"]}}" name="content">
        </td>
        <td>
          <input type="text" class="input-update" value="{{$item["lunch"]}}" name="content">
        </td>
        <td>
          <input type="text" class="input-update" value="{{$item["dinner"]}}" name="content">
        </td>
        <td>
